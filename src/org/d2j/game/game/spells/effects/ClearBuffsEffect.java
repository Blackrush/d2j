 ...
 * Time: 10:24
 */
public class ClearBuffsEffect extends Effect {
    public ClearBuffsEffect(ISpellLevel infos) {
        super(infos, SpellEffectsEnum.ClearBuffs);
    }
